...
public class PlayerResourceIntTest {
    ...
    public void createPlayer() throws Exception {
        ...
        assertThat(testPlayer.getPlayerId()).isEqualTo(DEFAULT_PLAYER_ID);
        assertThat(testPlayer.getStreak()).isEqualTo(DEFAULT_STREAK);
    ...
    public void updatePlayer() throws Exception {
        ...
        Player testPlayer = playerList.get(playerList.size() - 1);
        assertThat(testPlayer.getPlayerId()).isEqualTo(UPDATED_PLAYER_ID);
        assertThat(testPlayer.getStreak()).isEqualTo(UPDATED_STREAK);
