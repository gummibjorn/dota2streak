    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="dota2StreakApp.player.home.createOrEditLabel">Create or edit a Player</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : playerEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="player-playerId" type="string" className="form-control" name="playerId" />
                </AvGroup>
                <AvGroup>
                  <Label id="streakLabel" for="streak">
                    Streak
                  </Label>
                  <AvField id="player-streak" type="string" className="form-control" name="streak" />
                </AvGroup>
                <AvGroup>
