...
public class HealthApi {
    ...
    public Object healthGet() throws ApiException {
        ApiResponse<Object> resp = healthGetWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Object> healthGetWithHttpInfo() throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call healthGetAsync(final ApiCallback<Object> callback) throws ApiException {
