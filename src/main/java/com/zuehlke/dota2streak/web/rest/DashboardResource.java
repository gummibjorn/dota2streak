...
public class DashboardResource {
    ...
    @Timed
    public List<Dashboard> getAllDashboards(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get all Dashboards");
        return dashboardRepository.findAllWithEagerRelationships();
    }
    ...
    public ResponseEntity<Dashboard> getDashboard(@PathVariable Long id) {
        ...
        Optional<Dashboard> dashboard = dashboardRepository.findOneWithEagerRelationships(id);
